...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_5x6(
      ...
      KC_LCTL, KC_Z, KC_X, RGB_MODE_FORWARD, RGB_TOG, KC_B,                  KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_BSLS, 
	...
	[_NAV] = LAYOUT_5x6(
      KC_TRNS, PIPE, AT, HASH, DOLLAR, PERCENT,                CIRC,    AMP,     ASTERIX, LPARENS,   RPARENS, KC_MPLY, 
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS, KC_TRNS, KC_UP,   KC_TRNS,   KC_VOLD, KC_VOLU, 
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT,   KC_RGHT, DBL_QUOTE, 
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_PGDN, KC_TRNS, LESSER,  GREATER,   SLASH_QUEST,   KC_NO,
